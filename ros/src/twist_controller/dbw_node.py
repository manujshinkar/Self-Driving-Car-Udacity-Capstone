...
class DBWNode(object):
    def __init__(self):
        ...
        self.controller = Controller(car_params);
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            ...
            if not None in (self.current_velocity, self.proposed_linear_velocity, self.proposed_angular_velocity):
                throttle, brake, steer = self.controller.control(self.proposed_linear_velocity,
                                                                    self.proposed_angular_velocity,
                                                                    self.current_velocity, self.dbw_enabled, 1./50)
